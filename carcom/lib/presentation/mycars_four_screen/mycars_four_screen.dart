import '../mycars_four_screen/widgets/mycars_four_item_widget.dart';
...
class MycarsFourScreen extends GetWidget<MycarsFourController> {
  @override
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Obx(() => ListView.builder(
                              ...
                              shrinkWrap: true,
                              itemCount: controller.mycarsFourModelObj.value
                                  .mycarsFourItemList.length,
                              itemBuilder: (context, index) {
                                MycarsFourItemModel model = controller
                                    .mycarsFourModelObj
                                    .value
                                    .mycarsFourItemList[index];
                                return MycarsFourItemWidget(model,
