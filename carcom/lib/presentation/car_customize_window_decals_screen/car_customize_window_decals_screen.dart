...
class CarCustomizeWindowDecalsScreen extends StatelessWidget {
  @override
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Align(
                                                                        ...
                                                                        child: Padding(
                                                                            padding:
                                                                                getPadding(right: 17),
                                                                            child: Text("Save", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRobotoMedium12Black900.copyWith(letterSpacing: getHorizontalSize(0.50), height: getVerticalSize(1.14))))),
                                                                    Align(
                                                                        alignment:
                                                                            Alignment
                                                                                .bottomCenter,
                                                                        child: Padding(
                                                                            ...
                                                                            child: Text(" window tint", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRobotoMedium12Black90001.copyWith(letterSpacing: getHorizontalSize(0.50), height: getVerticalSize(1.14)))))
                                                                  ])),
                                                          Padding(
                                                              padding:
                                                                  getPadding(
  ...
  onTapStackcarcounter(BuildContext context) {
