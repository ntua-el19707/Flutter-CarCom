...
class BookApoitmentForm extends StatefulWidget {
  const BookApoitmentForm({super.key, required this.Mechanic});
...
// Step 2.
                        Container(
                            ...
                            child: DropdownButton<String>(
                              ...
                              value: dropdownValue,
                              // Step 4.
                              items: carPlates.map<DropdownMenuItem<String>>(
                                  (String value) {
                        ...
                        GestureDetector(
                            onTap: () {
                              print("Book appoitment wirh ${widget.Mechanic}");
                              print("Car:${this.dropdownValue}");
                              print(
                                  "Comments:${this.buildForm.controls['comment']?.value} Service at:${this.buildForm.controls['Service']?.value}  Time at${this.Time}");
                            },
                            child: Container(
                                child: CustomButton(
                              height: 60,
